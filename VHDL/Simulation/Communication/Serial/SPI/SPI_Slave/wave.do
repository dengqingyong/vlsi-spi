...
add wave -noupdate -format Logic /spi_slave_tb/spi_slave_inst/spi_sr_proc/prop_en
add wave -noupdate -format Logic /spi_slave_tb/spi_slave_inst/spi_sr_proc/samp_en
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {1609 ns} 0}
