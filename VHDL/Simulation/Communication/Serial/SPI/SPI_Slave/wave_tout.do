...
add wave -noupdate -format Literal /spi_slave_tout_tb/spi_slave_inst/next_st
...
add wave -noupdate -format Logic /spi_slave_tout_tb/spi_slave_inst/samp_en
add wave -noupdate -format Logic /spi_slave_tout_tb/spi_slave_inst/prop_en
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {2218160 ps} 0}
...
update
WaveRestoreZoom {2096735 ps} {2359235 ps}
